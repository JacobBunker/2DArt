...
def xfun(x,y,t,z):
    return x+((360*4)/(z*6))*np.cos(np.radians(t/4))
    
def yfun(x,y,t,z):
    return y+((360*4)/(z*6))*np.sin(np.radians(t/4))        
...
def recursive(x,y,level):
    ...
    drawCircle(x+2*(360*4/(level*4)),y,z,level)
    drawCircle(x,y+2*(360*4/(level*4)),z,level)
    drawCircle(x+2*(360*4/(level*4)),y+2*(360*4/(level*4)),z,level)
