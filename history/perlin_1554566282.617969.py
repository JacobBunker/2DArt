...
def recursive(x,y,level):
    ...
    drawCircle(x+2*(360*4/(level*6)),y,z,level)
    drawCircle(x,y+2*(360*4/(level*6)),z,level)
    drawCircle(x+2*(360*4/(level*6)),y+2*(360*4/(level*6)),z,level)
